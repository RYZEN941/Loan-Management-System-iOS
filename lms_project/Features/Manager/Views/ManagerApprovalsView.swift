    ...
    var body: some View {
        NavigationStack {
            ...
            .onAppear {
                ...
                selectedManagerChip = ManagerChip(rawValue: applicationsVM.managerFilterChip(for: applicationsVM.activeDashboardFilter)) ?? .all
            ...
            .sheet(isPresented: $showBorrowerHistorySheet) { borrowerHistoryListSheet }
        }
    }
